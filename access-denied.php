        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#etusivu">Yritys</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#palvelut">Palvelut</a></li>
                ...
                <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        ...
                        <div style="text-align:center">
                            <img style="height:200px; width:200px;" src="assets/img/accessdenied.jpg" > <br> <br>
                            <h3 style="text-align:center">Pääsy kielletty! <br> <br> Sinulla ei ole valtuuksia palveluun! </h3>
                            <a href="login-form.php>"> Tästä pääset kirjautumaan palveluun. </a>
        </section>
        <!-- Signup-->
