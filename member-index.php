        ...
        <section class="projects-section bg-light" id="palvelut">
            <div class="container">
                ...
                <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                    <div class="col-xl-10 col-lg-7"></div>
                    <div class="col-xl-10 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <p class="text-black-50 mb-0"><h3> Tervetuloa hallintapaneeliin <b><?php echo $_SESSION['SESS_NIMI'];?></b></h3> </p>
                            <img style="height:100px; width:100px;" src="assets/img/tilaustenhallinta.jpg">&nbsp; &nbsp; &nbsp; &nbsp;<a href="ajanvaraushallinta.php"> Tästä pääset muokkaamaan ajanvarauksia </a>
                            <br><br><br><br>
                            <img style="height:100px; width:100px;" src="assets/img/tilauslomake.jpg"> &nbsp; &nbsp; &nbsp;<a href="vuokrahallinta.php"> Lisää/poista auto vuokrauksesta </a>
                            <br><br><br><br>
                            <img style="height:100px; width:100px;" src="assets/img/tilauslomake.jpg"> &nbsp; &nbsp; &nbsp;<a href="kauppahallinta.php"> Lisää/poista auto myynnistä </a>
                            <br><br><br><br>
                            <img style="height:100px; width:100px;" src="assets/img/tilauslomake.jpg"> &nbsp; &nbsp; &nbsp;<a href="kauppahallinta2.php"> Päivitä myynnissä olevan auton tietoja </a>
                            <br><br><br><br>
                            <img style="height:100px; width:100px;" src="assets/img/logout.jpg"> &nbsp; &nbsp; &nbsp; <a href="logout.php"> Tästä pääset kirjautumaan ulos hallinnointipaneelista. </a>
                        </div>
                    </div>
                </div>
                            </div>
