        ...
        <section class="projects-section bg-light" id="palvelut">
            <div class="container">
                ...
                <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                    <div class="col-xl-8 col-lg-7"><img  class="img-fluid mb-3 mb-lg-0" src="assets/img/kirjautuminen.png" alt="" /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <p class="text-black-50 mb-0"><a href="login-form.php"> Tästä pääset kirjautumaan hallintapaneeliin. </a> </p> <br> <br> <br>
                            <?php
            ...
            $to = 'sutinenoy@gmail.com';
			$message = "Tässä uusi salasanasi Haukiauto hallinnointipaneeliin: <br> <br>";
			...
			$message .= "https://geronimo.okol.org/~karjon/Sutinen%20Oy/Nettisivut/login-form.php <br> <br> <br>";
			$message .= "Ystävällisin terveisin, <br>";
			$message .= "Haukiauto - IT-tuki"; 
			...
			$sql = "UPDATE sutinenoy SET salasana='$newpassword2' WHERE Kirjautumistunnus='$login'";

			if ($conn->query($sql) === TRUE) {
			echo "<br> Uusi salasana salattu tietokantaan!";
			} else {
