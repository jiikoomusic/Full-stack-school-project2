...
$Ajokorttiluokka = ($_POST['Ajokorttiluokka']);
$MerkkiMalli = ($_POST['MerkkiMalli']);
$Vuosimalli = ($_POST['Vuosimalli']);
$Polttoaine = ($_POST['Polttoaine']);
$Vaihteisto = ($_POST['Vaihteisto']);
$Henkilomaara = ($_POST['Henkilomaara']);
$Ilmastointi = ($_POST['Ilmastointi']);
$Lemmikit = ($_POST['Lemmikit']);
$Hinta = ($_POST['Hinta']);

$qry = "INSERT INTO vuokraus (Ajokorttiluokka, MerkkiMalli, Vuosimalli, Polttoaine, Vaihteisto, Henkilomaara, Ilmastointi, Lemmikit, Hinta) VALUES ('$Ajokorttiluokka', '$MerkkiMalli', '$Vuosimalli', '$Polttoaine' , '$Vaihteisto', '$Henkilomaara' , '$Ilmastointi' , '$Lemmikit' , '$Hinta') ";
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <a href="vuokrahallinta.php"> Tästä takaisin autojen hallintaan </a> <br> <br>
