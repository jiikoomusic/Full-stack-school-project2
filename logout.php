...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <p> Olet kirjautunut ulos Haukiauto - hallinnointipaneelista! </p>
        <a href="login-form.php"> Tästä takaisin kirjautumaan hallinnointipaneeliin. </a> <br> <br>
        <img style="align:center" src="assets/img/kirjautuminen.png">
        </div>
        </section>
        <!-- Signup-->
