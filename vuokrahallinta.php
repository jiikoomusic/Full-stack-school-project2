...
@media screen and (max-width: 600px) {
  .col-25, .col-75, input[type=submit] {
    ...
    <body id="page-top">
        ...
        <section class="projects-section bg-light" id="palvelut">
            ...
            <div style="text-align: center">
                <h3><b> Tervetuloa Haukiauton hallintapaneeliin! <br> <br>
                Täytä lomakkeen tiedot lisätäksesi auto vuokrausvalikoimaan.</b></h3><br><br>
                ...
                <div class="container">
                <form action="filesLogicvuokra.php" method="post" enctype="multipart/form-data" >
    <div class="row">
      <div class="col-25">
        <label for="Merkki">Ajokorttiluokka</label>
      </div>
      <div class="col-75">
        <input type="text" id="Ajokorttiluokka" name="Ajokorttiluokka">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="Malli">Auton merkki ja malli</label>
      </div>
      <div class="col-75">
        <input type="text" id="MerkkiMalli" name="MerkkiMalli">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      <div class="col-25">
        <label for="country">Henkilömäärä</label>
      </div>
      <div class="col-75">
        <select id="country" name="Henkilomaara">
    ...
    <div class="row">
      <div class="col-25">
        <label for="country">Ilmastointi</label>
      </div>
      <div class="col-75">
        <select id="country" name="Ilmastointi">
          <option value="Manuaali">Manuaalinen</option>
          <option value="Automaatti">Automaattinen</option>
          <option value="Ei">Ei ilmastointia</option>
        </select>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="country">Lemmikit</label>
      </div>
      <div class="col-75">
        <select id="country" name="Lemmikit">
          <option value="Sallittu">Sallittu</option>
          <option value="Ei sallittu">Ei sallittu</option>
        </select>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <input type="submit" name="save" value="Lisää auto vuokrausvalikoimaan">
    </div>
