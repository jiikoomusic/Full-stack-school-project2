...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <p class="text-black-50 mb-0"><h3> Tästä pääset kirjautumaan hallintapaneeliin. </h3> </p>
                            <form id="loginForm" name="loginForm" method="post" action="login-exec.php">
          <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
              <td width="112"><b>Tunnus</b></td>
              <td width="188"><input name="Kirjautumistunnus" type="text" class="textfield" id="Kirjautumistunnus" required/></td>
            </tr>
            <tr>
              <td><b>Salasana</b></td>
              <td><input name="Salasana" type="password" class="textfield" id="Salasana" required/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
        ...
        <form id="newpassword" name="newpassword" method="post" action="newpassword.php">
          <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
              <td width="112"><b>Sähköposti</b></td>
