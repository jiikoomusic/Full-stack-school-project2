        ...
        <section class="projects-section bg-light" id="palvelut">
            <div class="container">
                ...
                <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                    <div class="col-xl-8 col-lg-7"><img  class="img-fluid mb-3 mb-lg-0" src="assets/img/accessdenied.jpg" alt="" /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <p class="text-black-50 mb-0"><h3> Kirjautuminen epäonnistui, yritä uudestaan!</h3> </p>
                            <a href="login-form.php"> Takaisin kirjautumaan.</a>
