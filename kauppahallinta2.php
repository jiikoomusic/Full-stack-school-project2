...
input[type=submit]:hover {
  background-color: #000000;
    ...
    <body id="page-top">
        ...
        <a href="kauppahallinta.php"> Lisää tai poista autoja kaupasta </a> <br> <br> 
...
<?php 
                    ...
                    ?>
                        ...
                        <! Tästä alkaa sivun taulu> <div class="mx-auto text-center">
                            <h3 class="text-white-50"> Päivitä valitsemasi auton tietoja </h3>
                        <table style="position:relative; right:250px;" id="taulu"> 
                        <thead>
                        <th class="text-white-50"> Auton ID-numero </th> 
                        <th class="text-white-50"> Merkki </th> 
                        <th class="text-white-50"> Malli </th>
                        <th class="text-white-50"> Vuosimalli </th>
                        <th class="text-white-50"> Polttoaine </th>
                        <th class="text-white-50"> Vaihteisto </th>
                        <th class="text-white-50"> Rekisterinumero </th>
                        <th class="text-white-50"> Kilometrilukema </th>
                        <th class="text-white-50"> Katsastus </th>
                        <th class="text-white-50"> Hinta </th>
                        <th class="text-white-50"> Lisätiedot </th>
                        </thead>
                        <tbody>
                        <?php foreach ($seequl as $file): ?>
                        <tr>
                        <td><img src="<?php echo 'uploads/' . $file[7] ?>" width="250" height="200" alt=""></td> 
                        <td class="text-white-50"><?php echo $file[0];?></td>
                        ...
                        <td class="text-white-50"><a href="kauppamuutokset.php?id=<?php echo $file[0]; ?>">Päivitä tietoja</a></td>
                        </tr>
                        <?php endforeach;
                        ?> </table>
</div></div></section>
