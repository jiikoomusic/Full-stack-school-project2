...
$Email = ($_POST['Email']);
$Kilometrilukema = ($_POST['Kilometrilukema']);
$Rekisterinumero = ($_POST['Rekisterinumero']);
$Merkki = ($_POST['Merkki']);
$Malli = ($_POST['Malli']);
$Vuosimalli = ($_POST['Vuosimalli']);
$Polttoaine = ($_POST['Polttoaine']);
$Vaihteistotyyppi = ($_POST['Vaihteistotyyppi']);
$Ajankohta = ($_POST['Ajankohta']);
$Lisatietoja = ($_POST['Lisatietoja']);


        $subject = "Vahvistus tarjouspyynnön jättämisestä";
        $to = $Email;
        $message = "Kiitos tarjouspyynnöstäsi Haukiauto-autokorjaamolle! <br> <br>";
        $message .= "Valitsit huollon rekisterinumerolle: <br>";
        $message .= $Rekisterinumero . "<br> <br> <br>";
        $message .= "Valitsemasi päivä ja kellonaika: <br>";
        $message .= $Ajankohta . "<br> <br> <br>";
        $message .= "Haluamasi toimenpide: <br>";
        $message .= $Lisatietoja . "<br> <br> <br>";
        $message .= "Vastaamme tarjouspyyntöösi mahdollisimman pian. <br> Tarjouksen hyväksymällä ajanvarauksesi vahvistetaan. <br><br><br>";
        ...
        $subject = "Uusi ajanvaraus sivustoltasi";
        ...
        $message .= "Valitun auton rekisterinumero: <br>";
        $message .= $Rekisterinumero . "<br> <br> <br>";
        $message .= "Valitun auton merkki: <br>";
        $message .= $Merkki . "<br> <br> <br>";
        $message .= "Valitun auton malli: <br>";
        $message .= $Malli . "<br> <br> <br>";
        $message .= "Valitun auton vuosimalli: <br>";
        $message .= $Vuosimalli . "<br> <br> <br>";
        $message .= "Valitun auton polttoainetyyppi: <br>";
        $message .= $Polttoaine . "<br> <br> <br>";
        $message .= "Valitun auton vaihteistotyyppi: <br>";
        $message .= $Vaihteistotyyppi . "<br> <br> <br>";
        $message .= "Haluttu päivä ja kellonaika: <br>";
        $message .= $Ajankohta . "<br> <br> <br>";
        $message .= "Haluttu toimenpide: <br>";
        $message .= $Lisatietoja . "<br> <br> <br>";
        $header = "From:sutinenoy@gmail.com \r\n";
        $header .= "MIME-Version: 1.0\r\n";
        $header .= "Content-type: text/html\r\n";
...
$qry = "INSERT INTO ajanvaraus (Nimi, Puhelinnumero, Email, Kilometrilukema, Rekisterinumero, Merkki, Malli, Vuosimalli, Polttoaine, Vaihteistotyyppi, Ajankohta, Lisatietoja) VALUES ('$Nimi', '$Puhelinnumero', '$Email', '$Kilometrilukema', '$Rekisterinumero','$Merkki' ,'$Malli'  ,'$Vuosimalli'  ,'$Polttoaine'  ,'$Vaihteistotyyppi' , '$Ajankohta', '$Lisatietoja')";
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <h3> Ajanvaraus tehty onnistuneesti! </h3>
